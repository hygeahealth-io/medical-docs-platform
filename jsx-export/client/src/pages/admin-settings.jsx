...
function SystemSettings({ settings, onSave, isLoading }) {
...
function UserManagementSettings({ settings, onSave, isLoading }) {
  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-4">
          <Label>Max Users Per Tier</Label>
          <div className="grid grid-cols-3 gap-4">
            <div className="space-y-2">
              <Label htmlFor="max-standard">Standard</Label>
              <Input
                id="max-standard"
                type="number"
                value={userSettings.maxUsersPerTier.standard}
                onChange={(e) => setUserSettings({
                  ...userSettings, 
                  maxUsersPerTier: {
                    ...userSettings.maxUsersPerTier,
            ...
            <div className="space-y-2">
              <Label htmlFor="max-gold">Gold</Label>
              <Input
                id="max-gold"
                type="number"
                value={userSettings.maxUsersPerTier.gold}
                onChange={(e) => setUserSettings({
                  ...userSettings, 
                  maxUsersPerTier: {
                    ...userSettings.maxUsersPerTier,
            ...
            <div className="space-y-2">
              <Label htmlFor="max-platinum">Platinum</Label>
              <Input
                id="max-platinum"
                type="number"
                value={userSettings.maxUsersPerTier.platinum}
                onChange={(e) => setUserSettings({
                  ...userSettings, 
                  maxUsersPerTier: {
                    ...userSettings.maxUsersPerTier,
